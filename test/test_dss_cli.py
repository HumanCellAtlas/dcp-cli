...
class TestDssCLI(unittest.TestCase):
    ...
    def test_parsing(self):
        ...
        import hca.dss.error

        cli = hca.dss.cli.CLI(os.path.join(os.path.dirname(os.path.realpath(__file__)), "test.json"))
        ...
        self.assertRaises(hca.dss.error.PrintingException, cli.parse_args, args)
