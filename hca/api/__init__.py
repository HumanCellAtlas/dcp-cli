...
from .abstractions.download import Download
from .abstractions.upload import Upload
...
def put_bundles(uuid, replica, creator_uid, files, version=None, **kwargs):
    """
...
def put_files(uuid, bundle_uuid, creator_uid, source_url, version=None, **kwargs):
    """
...
def put_subscriptions(replica, callback_url, query, **kwargs):
    """
...
def download(uuid, name=None, replica='aws', **kwargs):
    """
