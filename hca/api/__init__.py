...
def put_subscriptions(query, callback_url, replica, ):
    """
    ...
    """
    return PutSubscriptions.run(callback_url, query, replica)


def delete_subscriptions(uuid, replica, ):
    """
    ...
    """
    return DeleteSubscriptions.run(uuid, replica)
...
def get_subscriptions(replica, uuid=None, ):
    """
    ...
    """
    return GetSubscriptions.run(uuid, replica)


def put_files(uuid, creator_uid, bundle_uuid, source_url, version=None, ):
    """
...
def get_bundles(uuid=None, version=None, replica=None, directurls=None, ):
    """
    ...
    """
    return GetBundles.run(uuid, directurls, replica, version)


def put_bundles(uuid, files, creator_uid, replica, version=None, ):
    """
